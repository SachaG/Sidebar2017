...
const SbUsersEditForm = (props, context) => {
  return (
    <Components.ShowIf
...
SbUsersEditForm.propTypes = {
  terms: PropTypes.object, // a user is defined by its unique _id or its unique slug
};

SbUsersEditForm.contextTypes = {
  intl: intlShape
};

SbUsersEditForm.displayName = "SbUsersEditForm";

replaceComponent('UsersEditForm', SbUsersEditForm);
